  ...
  KSampler: {
    input: {
      required: {
        ...
        cfg: [
          "FLOAT",
          { default: 8, min: 0, max: 100, step: 0.1, round: 0.01 },
        ],
        sampler_name: [
          [
            "euler",
  ...
  ImageSharpen: {
    input: {
      required: {
        ...
        sigma: ["FLOAT", { default: 1, min: 0.1, max: 10, step: 0.1 }],
        alpha: ["FLOAT", { default: 1, min: 0, max: 5, step: 0.1 }],
      },
    },
    output: ["IMAGE"],
    output_is_list: [false],
  ...
  KarrasScheduler: {
    input: {
      required: {
        ...
        rho: [
          "FLOAT",
          { default: 7, min: 0, max: 100, step: 0.01, round: false },
        ],
      },
    },
    output: ["SIGMAS"],
  ...
  PolyexponentialScheduler: {
    input: {
      required: {
        ...
        rho: [
          "FLOAT",
          { default: 1, min: 0, max: 100, step: 0.01, round: false },
        ],
      },
    },
    output: ["SIGMAS"],
  ...
  SamplerDPMPP_SDE: {
    input: {
      required: {
        ...
        r: [
          "FLOAT",
          { default: 0.5, min: 0, max: 100, step: 0.01, round: false },
        ],
        noise_device: [["gpu", "cpu"]],
      },
    },
  ...
  PatchModelAddDownscale: {
    input: {
      required: {
        ...
        downscale_factor: [
          "FLOAT",
          { default: 2, min: 0.1, max: 9, step: 0.001 },
        ],
        start_percent: ["FLOAT", { default: 0, min: 0, max: 1, step: 0.001 }],
  ...
  SVD_img2vid_Conditioning: {
    input: {
      required: {
        ...
        augmentation_level: [
          "FLOAT",
          { default: 0, min: 0, max: 10, step: 0.01 },
        ],
      },
    },
  ...
  VideoLinearCFGGuidance: {
    input: {
      required: {
        ...
        min_cfg: [
          "FLOAT",
          { default: 1, min: 0, max: 100, step: 0.5, round: 0.01 },
        ],
      },
    },
    output: ["MODEL"],
